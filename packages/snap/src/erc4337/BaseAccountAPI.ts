...
import { calcPreVerificationGas, GasOverheads } from '@account-abstraction/sdk'
 ...
 * - createUserOpToSign - helper to that create a userOp to sign
 */
export abstract class BaseAccountAPI {
   ...
   */
  async createUserOpToSign(info: TransactionDetailsForUserOp): Promise<{userOpHash: Uint8Array, userOp:UserOperationStruct}> {
